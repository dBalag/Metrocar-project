...
This query summarizes count of users & count of rides x each of the 7 step funnel, x each of the 3 platforms, x 5 age_ranges 
& x each download_date.
Its purpose is to get insights from the step funnel at a deeper levels (platforms, age_ranges, download_date).
I used this query in Tableau to make viz and being able to answer business questions 1, 2, 3 & 5.
...
Its purpose is to summarize x each hour how many rides has been requested, with that then being able to use it in Tableau and viz it to 
answer the business question number 4 about Price Surging Strategy.
*/
